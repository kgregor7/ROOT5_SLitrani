...
public:
  ...
  TLitCascade(const char*,const char*,const char*,const char*,Int_t=22,Double_t=100.0,
    TVector3=TVector3(1000000000.0,1000000000.0,1000000000.0),TVector3=TVector3(0.0,0.0,0.0),Double_t=0.05);
  TLitCascade(const char*,const char*,const char*,TLitMedium*,Int_t=22,Double_t=100.0,
    TVector3=TVector3(1000000000.0,1000000000.0,1000000000.0),TVector3=TVector3(0.0,0.0,0.0),Double_t=0.05);
  TLitCascade(const char*,const char*,const char*,TVector3,TVector3=TVector3(0.0,0.0,0.0),Int_t=22,
    Double_t=100.0,Double_t=0.05);
  TLitCascade(const char*,const char*,TLitMedium*,TVector3,TVector3=TVector3(0.0,0.0,0.0),Int_t=22,
    Double_t=100.0,Double_t=0.05);
  virtual        ~TLitCascade();
