...
TLitCascade::TLitCascade(const char *name, const char *title,const char *path, const char *namemed,Int_t pdg,Double_t E0,TVector3 StartCasc, TVector3 AxisCasc, Double_t photfac) {
  //
